...
final class BookedItemTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    public function datasource(): ?Builder
    {
        ...
        ->where('item_user.status', 'booked')
        ->select( 'item_user.id','item_user.start_date', 'item_user.status', 'item_user.total_price','item_user.end_date', 'items.name', 'items.description',  'types.name as type_name', 'categories.name as category_name', 'users.name as user_name');
    }
