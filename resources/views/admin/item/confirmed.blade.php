                ...
                <tbody>
                    @foreach ($items as $item)
                        <tr>
                            ...
                            <td><a class="btn btn-primary btn-sm" href="{{route('items.admin-update', ['item_id' => $item->id, 'status' => 'approved'])}}">Approved</a></td>
                            <td><a class="btn btn-danger btn-sm" href="{{route('items.admin-update', ['item_id' => $item->id, 'status' => 'rejected'])}}">Reject</a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
